	...
	<view>
		...
		<view class="uni-padding-wrap uni-common-mt">
			...
			<view class="uni-btn-v">
				...
				<button type="primary" :disabled="disabled[8]" @click="sendData">写入特征值数据</button>
				<!-- <button type="primary" :disabled="disabled[9]" @click="closeBLEConnection"> -->
				<button type="primary" :disabled="disabled[9]" @click="notifyBLECharacteristicValueChange">
					断开蓝牙设备
				</button>
...
export default {
	...
	methods: {
		...
		notifyBLECharacteristicValueChange() {
			...
			console.log(serviceId);
			console.log(characteristicId);
			console.log(this.ab2hex(notify));
		...
		sendData(buffer) {
			let deviceId = this.equipment[0].deviceId;
			let buffer1 =  "createBLEConnection:ok";
